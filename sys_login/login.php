...
<body>
  ...
  <div class="container">
    <h1 class="mb-3">เข้าสู่ระบบผู้ดูแล</h1>
    <hr>
    <form method="post">
        <div class="mb-3">
        ...
        <button type="submit" name="login" class="btn btn-success">เข้าอยู่ระบบ</button>
        <a href="./indexRel.php" class="btn btn-primary">ลงทะเบียน</a>
