...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h3 style="font-size:600%; color:#3949ab;">ไวรัสคอมพิวเตอร์</h3>
                </div>
            </div>
            </form>
        </div>
    ...
    <div class="text-center">
        <div class="content">
            '<img src="./img/03.png" width="560" height="415" class="img-thumbnail" alt="Cinque Terre">
        </div>
        <br>
    </div>
    ...
    <div class="container">
        <div class="row">
            <h3 style="color: rgb(0, 110, 201);">ไวรัสคอมพิวเตอร์มีอะไรบ้าง</h3>
        </div>
    </div>
    ...
    <div class="container overflow-hidden">
        <div class="row gy-5">
            <div class="col-12">
                <br>
                <h5 style="font-size:130%;"><b> <p>ไวรัสคอมพิวเตอร์ (computer virus) เป็นคำเรียกของชุดโปรแกรมคอมพิวเตอร์ หรือชุดคำสั่งบนระบบปฏิบัติการใด ๆ ซึ่งถูกเขียนขึ้นมาเพื่อให้ทำงานในการใดการหนึ่ง อาจมีประโยชน์ หรือโทษก็ได้ แต่โดยส่วนใหญ่เป็นไปในทางโทษที่ทำให้เกิดความเสียหาย ทำให้คอมพิวเตอร์ไม่สามารถทำงานได้ หรือทำงานได้โดยไม่สะดวก</p>
                <p>โดยส่วนใหญ่โปรกรมไวรัสที่ถูกสร้างหรือเขียนขึ้นมา มักมีเป้าหมายสร้างความเสียหายซึ่งมีลักษณะเหมือนเชื้อโรคขนาดเล็ก ดังนั้นไวรัสคอมพิวเตอร์จึงมีพฤติกรรมในลักษณะเดียวกับไวรัสในทางชีววิทยา ซึ่งสามารถแพร่กระจายไปในเซลล์ของสิ่งมีชีวิตในลักษณะเดียวกัน จึงเป็นที่มาของคำว่า ไวรัส  </p> </h5>
                <br>
