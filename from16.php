...
<head>
    ...
    <style>
        ...
        header {
            background: url('./img/18.jpg') no-repeat center center;
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h3 style="font-size:600%; color:#512da8;">ลำโพง</h3>
                </div>
            </div>
            </form>
        </div>
    ...
    <div class="text-center">
        <div class="content">
            '<img src="./img/18.jpg" width="560" height="415" class="img-thumbnail" alt="Cinque Terre">
        </div>
        <br>
    </div>
    ...
    <div class="container">
        <div class="row">
            <h3 style="color: rgb(0, 110, 201);">ลำโพงคืออะไร</h3>
        </div>
    </div>
    ...
    <div class="container overflow-hidden">
        <div class="row gy-5">
            <div class="col-12">
                <br>
                <h5 style="font-size:130%;"><b>ลำโพง (อังกฤษ: loudspeaker, speaker) เป็นอุปกรณ์ไฟฟ้าเชิงกลอย่างหนึ่ง ทำหน้าที่แปลงสัญญาณไฟฟ้าให้เป็นเสียง มีด้วยกันหลายแบบ คำว่า ลำโพงมักจะเรียกรวมกัน ทั้งดอกลำโพง หรือตัวขับ (driver) และลำโพงทั้งตู้ (speaker system) ที่ประกอบด้วยลำโพงและวงจรอิเล็กทรอนิกส์สำหรับแบ่งย่านความถี่ (Crossover Network)

                        ลำโพงนับเป็นองค์ประกอบที่สำคัญในระบบเครื่องเสียง โดยมีขนาดตั้งแต่เล็กเท่าปลายนิ้ว จนถึงใหญ่ขนาดเส้นผ่าศูนย์กลางนับสิบนิ้ว โดยมีโครงสร้างที่แตกต่างกัน และให้เสียงที่แตกต่างกันด้วย</h5>
                <br>
