...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h3 style="font-size:600%; color:#558b2f;">ฮาร์ดดิสก์</h3>
                </div>
            </div>
            </form>
        </div>
    ...
    <div class="text-center">
        <div class="content">
            '<img src="./img/14.jpg" width="560" height="415" class="img-thumbnail" alt="Cinque Terre">
        </div>
        <br>
    </div>
    ...
    <div class="container">
        <div class="row">
            <h3 style="color: rgb(0, 110, 201);">ฮาร์ดดิสก์ ตืออะไร</h3>
        </div>
    </div>
    ...
    <div class="container overflow-hidden">
        <div class="row gy-5">
            <div class="col-12">
                <br>
                <h5 style="font-size:130%;"><b> ฮาร์ดดิสก์ หรือ จานบันทึกแบบแข็ง (อังกฤษ: hard disk drive) คือ อุปกรณ์คอมพิวเตอร์ที่บรรจุข้อมูลแบบไม่ลบเลือน มีลักษณะเป็นจานโลหะที่เคลือบด้วยสารแม่เหล็กซึ่งหมุนอย่างรวดเร็วเมื่อทำงาน การติดตั้งเข้ากับตัวคอมพิวเตอร์สามารถทำได้ผ่านการต่อเข้ากับแผงวงจรหลัก (motherboard) ที่มีอินเตอร์เฟซแบบขนาน (PATA) , แบบอนุกรม (SATA) และแบบเล็ก (SCSI) ทั้งยังสามารถต่อเข้าเครื่องจากภายนอกได้ผ่านทางสายยูเอสบี, สายไฟร์ไวร์ รวมไปถึงอินเตอร์เฟซอนุกรมแบบต่อนอก (eSATA) ซึ่งทำให้การใช้ฮาร์ดดิสก์ทำได้สะดวกยิ่งขึ้นเมื่อไม่มีคอมพิวเตอร์ถาวรเป็นของตนเอง</h5>
                <br>
