        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    ...
                    if (!empty($cmsRecords)) {
                        // Display the first 'fname' value in the header
                        echo '<h3 style="font-size:600%; color:#ff1683f8;">' . $cmsRecords[0]['fname'] . '</h3>';
                    } else {
    ...
    <body>
        ...
        <div class="text-center">
            <div class="content">
                ...
                // Check if there are records
                if (!empty($cmsRecords)) {
                    echo '<img src="' . $cmsRecords[0]['fimg'] . '" width="560" height="415" class="img-thumbnail" alt="Image">';
                } else {
                    echo '<p>No records found.</p>';
                }
                ?>
        ...
        <div class="container">
            <div class="row">
                ...
                // Check if there are records
                if (!empty($cmsRecords)) {
                    echo  '<h3 style="color: rgb(0, 110, 201);">' . $cmsRecords[0]['fone'] . '</h3>';
                } else {
                    echo '<p>No records found.</p>';
                }
                ?>
        ...
        <div class="container overflow-hidden">
            <div class="row gy-5">
                <div class="col-12">
                    ...
                    // Check if there are records
                    if (!empty($cmsRecords)) {
                        echo  '<h5 style="font-size:120%;">' . $cmsRecords[0]['ftwo'] . '</h5>';
                    } else {
                        echo '<p>No records found.</p>';
                    }
                    ?>
