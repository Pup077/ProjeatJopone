...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h3 style="font-size:600%; color:#424242;">ซอฟต์แวร์</h3>
                </div>
            </div>
            </form>
        </div>
    ...
    <div class="text-center">
        <div class="content">
            '<img src="./img/17.jpg" width="560" height="415" class="img-thumbnail" alt="Cinque Terre">
        </div>
        <br>
    </div>
    ...
    <div class="container">
        <div class="row">
            <h3 style="color: rgb(0, 110, 201);">ซอฟต์แวร์คืออะไร</h3>
        </div>
    </div>
    ...
    <div class="container overflow-hidden">
        <div class="row gy-5">
            <div class="col-12">
                <br>
                <h5 style="font-size:130%;"><b><p>ซอฟต์แวร์ คือ ชุดคำสั่งหรือโปรแกรมที่ใช้ควบคุมการทำงานของเครื่องคอมพิวเตอร์ ที่จะทำให้ตัวคอมพิวเตอร์นั้นทำงานได้ตามจุดประสงค์ที่ผู้ใช้ต้องการ เขียนขึ้นโดยการใช้ภาษาคอมพิวเตอร์จากนักเขียนโปรแกรม เนื่องจากคอมพิวเตอร์นั้นมีการทำงานตามขั้นลำดับ ภาษาที่ใช้ในการเขียนโปรแกรม ก็จะมีลักษณะรูปแบบเฉพาะ ที่จะสามารถทำให้เครื่องคอมพิวเตอร์สามารถเข้าใจได้ เช่น ภาษาเบสิก ภาษาโคบอล ภาษาปาสคาล เป็นต้น</p>
                       <p>ซึ่งเมื่อติดตั้งซอฟต์แวร์เข้าไปในคอมพิวเตอร์เครื่องดังกล่าวแล้ว ตัวซอฟต์แวร์นี่แหละ ที่จะเป็นสิ่งที่ทำหน้าที่สั่งการให้คอมพิวเตอร์ทำการประมวลผลโดยอัตโนมัติ ช่วยให้มนุษย์ไม่ต้องเข้าไปวุ่นวายในการจัดลำดับ หรือขั้นตอนการประมวลอันแสนยุ่งยากของมัน ทุ่นเวลาในการทำงานลงไปได้เป็นจำนวนมาก</p></h5>
